...
public class EventListener extends PaperListener {
    ...
    public void onEntityRemove(EntityRemoveEvent event) {
        EntityBypassRegistry.markEntityDespawned(event.getEntity().getEntityId(), currentTickSupplier.getAsInt());
    }
    ...
    public void serverTickStopEvent(ServerTickEndEvent event) {
        // Completes the bypass removals whose straggler grace period has elapsed.
        EntityBypassRegistry.purgeDespawnedEntities(currentTickSupplier.getAsInt());
    }
